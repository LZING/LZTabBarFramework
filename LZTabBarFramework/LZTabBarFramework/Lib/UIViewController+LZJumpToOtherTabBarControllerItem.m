//
//  UIViewController+LZJumpToOtherTabBarControllerItem.m
//  LZTabBarFramework
//
...
@implementation UIViewController (LZJumpToOtherTabBarControllerItem)
...
- (void)lz_jumpToOtherTabBarControllerItem:(Class)ClassType
    ...
    [self lz_jumpToOtherTabBarControllerItem:ClassType performSelector:selector arguments:arguments returnValue:nil];
}
...
- (void)lz_jumpToOtherTabBarControllerItem:(Class)ClassType
    ...
    LZTabBarController *tabbarController = [self lz_tabBarController];
    ...
    if (!selectingIndex || selectingIndex >= tabbarController.viewControllers.count) {
        ...
        class name: %@                                                                                    \n \
        ------line: %@                                                                                    \n \
        ----reason: Class Type :%@ or its NavigationController is not the item of LZTabBarViewController \n \
        ------ END ---------------------------------------------------------------------------------------\n\n";
...
+ (void)callMethodWithTarget:(id)target selector:(SEL)selector arguments:(NSArray *)arguments returnValue:(void *)returnValue {
    if ([target respondsToSelector:selector]) {
        ...
        [self lz_invokeMethodWithTarget:target method:m arguments:arguments returnValue:returnValue];
    }
}

+ (void)lz_invokeMethodWithTarget:(id)target method:(Method)method arguments:(NSArray *)arguments returnValue:(void *)returnValue {
